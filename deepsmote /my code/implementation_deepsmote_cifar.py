...
def visualize_generation(encoder, decoder, minority_loader, config):
    encoder.eval(); decoder.eval()
    ...
    for i in range(8):
        ...
        if i == 0: axes[1, i].set_title("Synthetic (SMOTE)", fontweight='bold')
...
visualize_generation(encoder, decoder, minority_loader, config)
