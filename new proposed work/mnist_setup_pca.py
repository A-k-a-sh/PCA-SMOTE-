...
print("="*60)
print("Re-run train_and_evaluate calls above and compare:")
print("  Phase 1  — Baseline (Imbalanced)")
print("  Phase 1.5 — Pixel SMOTE (Balanced)")
print("  Phase 3  — DeepSMOTE (Balanced)")
print("  Phase 4  — PCA-SMOTE [PROPOSED] (Balanced)")
