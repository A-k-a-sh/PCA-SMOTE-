...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{fig1_target_sweep}
...
\label{subsec:impl}
We evaluate our approach on two image classification benchmarks: MNIST \citep{lecun1998gradient} and CIFAR-10 \citep{krizhevsky2009learning}. While previous works evaluated DeepSMOTE under moderate absolute minority counts (e.g., $n \ge 400$), we establish an extreme imbalance regime to stress-test the latent manifold. For MNIST, we use a 100:1 imbalance ratio, reducing Class 9 to $n=40$ samples. For CIFAR-10, we establish a 25:1 ratio, reducing the Airplane class to $n=80$ samples. 
