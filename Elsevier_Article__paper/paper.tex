...
However, their behavior under \emph{extreme} imbalance (minority class size
...
eliminates noisy high-dimensional interpolation artifacts.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.48\linewidth]{fig6a_real_vs_synth_mnist.png}
    \hfill
    \includegraphics[width=0.48\linewidth]{fig6b_real_vs_synth_cifar.png}
